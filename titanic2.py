...
title  = pd.get_dummies(full_set.Title)
...
full_set_X = pd.concat([deck, sex, title, full_set['Age'], full_set['Fare'], full_set['Pclass'], full_set['Parch'] ], axis=1)
